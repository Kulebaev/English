			...
			<header class="header">
				<div class="top_block fixed">
					...
					<div class="footer_bc">
						<ul class="social">
							<li>
								<a href="https://vk.com/write15415479" class="vk" aria-label="Вконтакте" alt="Вконтакте"></a>
							</li>
							<li>
			...
			<section id="price" class="advertising_bot" >  
				<div class="advertising_text fixed">		
					...
					<div class="ad_text">
						...
						<span class="ad_span">*Программа предназначена для пользователей с начальным уровнем владения языком и направлена на развитие разговорной речи, навыков восприятия языка на слух, чтения, устного и письменного перевода. Содержит полный курс грамматики, подкреплённый системой упражнений и тестов.<br>
						<br>Программа предназначена для пользователей с начальным уровнем владения языком и направлена на развитие разговорной речи, навыков восприятия языка на слух, чтения, устного и письменного перевода. Содержит полный курс грамматики, подкреплённый системой упражнений и тестов.<br>	
						<br>Типичный пользователь программы - человек, уже изучавший английский язык ранее, в школе или институте, но неудовлетворённый своими возможностями в языке.<br>
						<br>Программа предназначена для пользователей с начальным уровнем владения языком и направлена на развитие разговорной речи, навыков восприятия языка на слух, чтения, устного и письменного перевода. Содержит полный курс грамматики, подкреплённый системой упражнений и тестов.
					</span>
					</div>
				</div>				
			</section>			
